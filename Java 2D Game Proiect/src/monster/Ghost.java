...
public class Ghost extends Entity {
    ...
    {
        down1=setup("/monsters/right",gp.tileSize,gp.tileSize);
        down2=setup("/monsters/right",gp.tileSize,gp.tileSize);
        down3=setup("/monsters/right",gp.tileSize,gp.tileSize);
