...
public class Player extends Entity {
    ...
    public void getPlayerImage() {
        ...
        up3 = setup("/texture/spate2", gp.tileSize, gp.tileSize);
        up4 = setup("/texture/spate2", gp.tileSize, gp.tileSize);
        up5 = setup("/texture/spate2", gp.tileSize, gp.tileSize);
    ...
    public void getPlayerAttackImage() {
        ...
        attackDown3 = setup("/texture/attack_down2", gp.tileSize, gp.tileSize);
        attackDown4 = setup("/texture/attack_down3", gp.tileSize, gp.tileSize);
        attackDown5 = setup("/texture/attack_down3", gp.tileSize, gp.tileSize);
        ...
        attackLeft3 = setup("/texture/attack3", gp.tileSize, gp.tileSize);
        attackLeft4 = setup("/texture/attack4", gp.tileSize, gp.tileSize);
        attackLeft5 = setup("/texture/attack5", gp.tileSize, gp.tileSize);
        ...
        attackRight3 = setup("/texture/attack3", gp.tileSize, gp.tileSize);
        attackRight4 = setup("/texture/attack4", gp.tileSize, gp.tileSize);
        attackRight5 = setup("/texture/attack5", gp.tileSize, gp.tileSize);
    }
